...
public class FormIndex extends javax.swing.JFrame {
    ...
    private void btnMesasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMesasActionPerformed
        try {
            ...
            ventanaActual = formMesa; // Establece el nuevo formulario como el actual
            this.setVisible(false); // Oculta el FormIndex al abrir FormMesa
    ...
    private void btnProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProductosActionPerformed
        try {
            ...
            ventanaActual = formProducto;// Establece el nuevo formulario como el actual
            this.setVisible(false);// Oculta el FormIndex al abrir FormProducto
        } catch (SQLException ex) {
            Logger.getLogger(FormIndex.class.getName()).log(Level.SEVERE, null, ex);
        }
